...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.taravatgroup.taradodha", "ir.taravatgroup.taradodha.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.taradodha.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
